...
document.addEventListener('DOMContentLoaded', () => {
        ...
        document.addEventListener('mousemove', (e) => {
            ...
            const distance = Math.min(
                ...
                Math.hypot(e.clientX - eyeCenterX, e.clientY - eyeCenterY) /
                    DYSTOPIA_CONFIG.EYE_DISTANCE_DIVISOR,
            )
    ...
    titles.forEach((title) => {
        ...
        const glitchText = () => {
            ...
            if (
                now - lastGlitch >
                DYSTOPIA_CONFIG.GLITCH_MIN_INTERVAL +
                    Math.random() *
                        (DYSTOPIA_CONFIG.GLITCH_MAX_INTERVAL - DYSTOPIA_CONFIG.GLITCH_MIN_INTERVAL)
            ) {
        ...
        btn.addEventListener('click', () => {
            try {
                ...
                gainNode.gain.exponentialRampToValueAtTime(
                    0.01,
                    audioContext.currentTime + DYSTOPIA_CONFIG.AUDIO_DURATION,
                )
